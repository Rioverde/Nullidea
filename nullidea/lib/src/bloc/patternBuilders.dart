...
import 'package:nullidea/src/bloc/fieds.dart';

import 'package:nullidea/src/bloc/textButton.dart';
import 'package:nullidea/src/constants/nullideaTheme.dart';
import 'package:nullidea/src/constants/vars.dart';
...
TextButton buildTextButton(BuildContext context) {
  return TextButton(
    pressed: () => Navigator.pushNamed(context, '/signUp'),
